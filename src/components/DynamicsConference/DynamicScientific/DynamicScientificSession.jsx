...
import { DynamicSessionData } from "./DyanamicSessionData";
import MicIcon from "@mui/icons-material/Mic";
import RemoveIcon from "@mui/icons-material/Remove";

const DynamicsScientificConference = () => {
  ...
  return (
    <div className="scientific-sessions-container">
      ...
      <div className="scientific-sessions-main">
        {DynamicSessionData.map((item, index) => (
          <div
            key={index}
...
export default DynamicsScientificConference;
