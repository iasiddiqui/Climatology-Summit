...
import { ScientificPageHealthData } from "./ScientificPageHealthData";
      ...
      <>
        ...
        <div className="hero-section">
          ...
          <div className="overlay">
            <h1 className="scientific-page-h1"> Climate Change and Public Health Scientific Sessions</h1>
            <h2 className="scientific-page-h2">Here are a few trending topics in Climate Change and Public Health Science Research</h2>
          </div>
        </div>
        <div className="scientific-sessions-container">
          ...
          <div className="scientific-sessions-main">
            {ScientificPageHealthData.map((item, index) => (
              <div
                key={index}
...
export default ScientificPageHealth