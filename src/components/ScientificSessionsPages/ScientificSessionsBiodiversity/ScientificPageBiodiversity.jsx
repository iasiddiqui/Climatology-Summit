...
import { ScientificPageBiodiversityData } from "./ScientificPageBiodiversityData";
...
const ScientificPageBiodiversity = () => {
    ...
    <>
      ...
      <div className="hero-section">
        ...
        <div className="overlay">
          <h1 className="scientific-page-h1">
            {" "}
            Green Technologies Scientific Sessions
          </h1>
          <h2 className="scientific-page-h2">
            {" "}
      ...
      <div className="scientific-sessions-container">
        <h1 className="scientific-sessions-h1">
          Climate Change and Public Health Scientific Sessions
        </h1>
        <p className="scientific-sessions-p">
          Here are a few trending topics in Climate Change and Biodiversity
          Research
        </p>

        <div className="scientific-sessions-main">
          {ScientificPageBiodiversityData.map((item, index) => (
            <div
              key={index}
...
export default ScientificPageBiodiversity;
