...
import { ScientificPageDynamicsData } from "./ScientificPageDynamicsData";
    ...
    <>
      ...
      <div className="scientific-sessions-container">
        <h1 className="scientific-sessions-h1">
          Ocean Health and Climate Dynamics Scientific Sessions
        </h1>
        <p className="scientific-sessions-p">
          Here are a few trending topics in Ocean Health and Climate Dynamics
          Research
        </p>

        <div className="scientific-sessions-main">
          {ScientificPageDynamicsData.map((item, index) => (
            <div
              key={index}
...
export default ScientificPageDynamics;
