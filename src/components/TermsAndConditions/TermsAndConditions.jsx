    ...
    <>
      ...
      <div className="terms-container">
        <div className="upper-section">
          ...
          <h1 className="terms-link-h1">
            <Link className="terms-link" to="/">www.climatologysummit.com</Link>
          </h1>
          <p className="terms-p">Last updated: November 17, 2023 </p>
          <p className="terms-p">
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <h1 className="terms-h1">Interpretation and Definitions</h1>
        </div>

        <div className="terms-content">
          <h2 className="terms-h2">Interpretation</h2>
          ...
          <h2 className="terms-h2">Definitions</h2>
          <p className="terms-para">
          ...
          <ul className="terms-ul">
            ...
            <li className="terms-li">
              ...
              in this Agreement) refers to Stripe Conferences, Palo Alto,
              California 94303, United States.
            </li>
            <li className="terms-li">
              Device means any device that can access the Service such as a
              computer, a cellphone, or a digital tablet.
            </li>
            <li className="terms-li">Service refers to the Website.</li>
            <li className="terms-li">
            ...
            <li className="terms-li">Website refers to Stripe Conferences.</li>
            <li className="terms-li">
          ...
          <h2 className="terms-h2">Acknowledgment</h2>
          <p className="terms-para">
          ...
          <h2 className="terms-h2">Links to Other Websites</h2>
          <p className="terms-para">
          ...
          <h2 className="terms-h2">“AS IS” and “AS AVAILABLE” Disclaimer </h2>
          <p className="terms-para">
          ...
          <h2 className="terms-h2">Disputes Resolution </h2>
          <p className="terms-para">
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h2 className="terms-h2">For European Union (EU) Users </h2>
          <p className="terms-para">
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h2 className="terms-h2">United States Legal Compliance </h2>
          <p className="terms-para">
          ...
          <h1 className="terms-h1">Severability and Waiver </h1>

          <h2 className="terms-h2">Severability </h2>
          <p className="terms-para">
          ...
          <h2 className="terms-h2">Waiver </h2>
          <p className="terms-para">
          ...
          <h2 className="terms-h2">Translation Interpretation </h2>
          <p className="terms-para">
          ...
          <h1 className="terms-h1">Changes to These Terms and Conditions </h1>
          <p className="terms-para">
          ...
          <ul className="terms-ul">
            <li className="terms-li">
              By email: support@stripeconferences.com{" "}
            </li>
            <li className="terms-li">
              By visiting this page on our website:{" "}
              <a
                className="terms-link"
                href="https://www.stripeconferences.com/stripe-conferences-contact-us/"
              >
                https://www.stripeconferences.com/stripe-conferences-contact-us/{" "}
              </a>
            </li>
            <li className="terms-li">By phone number: +1 630 259 0521</li>
          </ul>

          <h2 className="terms-h2">Locations</h2>
          <p className="terms-para">
            Stripe Conferences Inc
            <br />{" "}
          ...
          <p className="terms-para">
            Symposyo Events Private Limited
            <br />{" "}
            <span className="terms-span">
              {" "}
              Unit 704C PSR Prime Towers Gachibowli, Hyderabad, Telangana, India
              500032
            </span>
          </p>
        </div>
