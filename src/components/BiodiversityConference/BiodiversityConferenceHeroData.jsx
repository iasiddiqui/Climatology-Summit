const BioDiversityHeroData = {
    title: "Climate Change and Biodiversity",
    theme: " Navigating Climate Change Impacts: Strategies for Biodiversity Conservation and Resilience",
  ...
  export default BioDiversityHeroData;
